...
public class Manager {
    ...
    private String FLAVAZ_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public Manager(Context appContext) {
    ...
    //Saves the image into a folder called theImageName

    public String putImage(String theFolder, String theImageName, Bitmap theBitmap) {
        if (theFolder == null || theImageName == null || theBitmap == null)
            return null;

        this.FLAVAZ_APP_IMAGEDATA_DIRECTORY = theFolder;
    ...
    //Saves the Bitmap into fullPath
    ...
    private String setupFullPath(String imageName) {
        File mFolder = new File(Environment.getExternalStorageDirectory(), FLAVAZ_APP_IMAGEDATA_DIRECTORY);
